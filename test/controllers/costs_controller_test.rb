...
class CostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cost" do
    assert_difference('Cost.count') do
      post costs_url, params: { cost: { brand: @cost.brand, color: @cost.color, medida: @cost.medida, modelo: @cost.modelo, precio_esp: @cost.precio_esp, type: @cost.type, upc: @cost.upc } }
    end
  ...
  test "should update cost" do
    patch cost_url(@cost), params: { cost: { brand: @cost.brand, color: @cost.color, medida: @cost.medida, modelo: @cost.modelo, precio_esp: @cost.precio_esp, type: @cost.type, upc: @cost.upc } }
